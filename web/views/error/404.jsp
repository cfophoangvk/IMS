...
<html lang="en">
    ...
    <body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
        <div class="max-w-md w-full text-center">
            <div class="w-32 h-32 bg-blue-100 text-blue-500 rounded-full flex items-center justify-center mx-auto mb-8 shadow-inner">
                <i class="fas fa-search text-6xl"></i>
            </div>

            <h1 class="text-6xl font-bold text-gray-900 mb-4 tracking-tight">404</h1>
            <h2 class="text-2xl font-semibold text-gray-800 mb-3">Không tìm thấy trang</h2>
            <p class="text-gray-500 mb-8">Trang bạn đang tìm kiếm có thể đã bị xóa, đổi tên hoặc tạm thời không thể truy cập.</p>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <button onclick="window.history.back()" class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors cursor-pointer">
                    <i class="fas fa-arrow-left mr-2"></i>Quay lại
                </button>
            </div>

            <div class="mt-12 text-sm text-gray-400 flex justify-center items-center gap-2">
                <p><jsp:include page="/assets/icons/box.jsp"/> ${java.time.Year.now().getValue()} IMS System. All rights reserved.</p>
            </div>
        </div>
    </body>
</html>
