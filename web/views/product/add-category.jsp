    ...
    <div class="min-h-screen bg-gray-50">
        <div class="bg-white shadow-sm border-b">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Thêm danh mục</h1>
                    <p class="text-sm text-gray-500 mt-1">Tạo danh mục sản phẩm mới</p>
                </div>
            </div>
        </div>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                <div class="p-6 border-b bg-gray-50 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800"><i class="fas fa-tags mr-2 text-blue-600"></i>Thông tin danh mục</h2>
                </div>
                <form action="${pageContext.request.contextPath}/category/add" method="POST" class="p-6 space-y-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tên danh mục <span class="text-red-500">*</span></label>
                        <input type="text" name="categoryName" value="${categoryName}" required placeholder="VD: Điện tử, Thực phẩm..."
