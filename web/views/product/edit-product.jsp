        ...
        <div class="bg-white shadow-sm border-b">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Cập nhật: <strong>${product.productCode}</strong></p>
                </div>
            </div>
        </div>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                <div class="p-6 border-b bg-gray-50 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800"><i class="fas fa-edit mr-2 text-blue-600"></i>Thông tin sản phẩm</h2>
                </div>
                <form action="${pageContext.request.contextPath}/product/edit" method="POST" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400">Mã sản phẩm không thể thay đổi</p>
                    </div>
                    <div>
