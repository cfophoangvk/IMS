        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                <div class="p-6 border-b bg-gray-50 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800"><i class="fas fa-user-plus mr-2 text-blue-600"></i>Thông tin tài khoản</h2>
                    <p class="text-sm text-gray-500 mt-1">Mật khẩu sẽ được tạo tự động. Sau khi tạo, bấm "Gửi email" để gửi thông tin đăng nhập.</p>
                </div>
                <form action="${pageContext.request.contextPath}/user/create" method="POST" class="p-6 space-y-5">
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-400">3-50 ký tự, chỉ chứa chữ cái, số và dấu gạch dưới (_)</p>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="roleId" required
                            ...
                            <c:forEach var="role" items="${roles}">
                                <option value="${role.roleId}" ${roleId == role.roleId ? 'selected' : ''}>${role.roleName} - ${role.description}</option>
                            </c:forEach>
                        </select>
                    </div>
