    ...
    <div class="min-h-screen bg-gray-50 pb-12">
        <div class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center">
                    <a href="${pageContext.request.contextPath}/user/list" class="mr-4 text-gray-400 hover:text-gray-600 transition">
                        <i class="fas fa-arrow-left text-xl"></i>
                    </a>
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Nhập tài khoản bằng Excel</h1>
                        <p class="text-sm text-gray-500 mt-1">Tải lên file Excel (.xlsx, .xls) để tạo nhiều tài khoản cùng lúc</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                <form action="${pageContext.request.contextPath}/user/create-excel" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <div class="flex flex-col md:flex-row md:items-end gap-6">
                        ...
                        <div class="flex flex-col items-center gap-3 pb-1">
                            <a class="bg-blue-500 text-white px-6 py-2.5 hover:bg-blue-600 text-sm font-medium rounded-lg font-medium transition" href="${pageContext.request.contextPath}/assets/excel/user-template.xlsx" download="user-template.xlsx"><i class="fas fa-download mr-1"></i>Tải xuống file mẫu</a>
                        ...
                        <table class="w-full text-sm text-left">
                            <thead class="text-xs text-gray-500 uppercase bg-gray-50/50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 font-semibold">Tài khoản</th>
                                    <th class="px-6 py-3 font-semibold">Vai trò ID</th>
                                ...
                                <c:forEach var="item" items="${results}" varStatus="loop">
                                    <tr class="hover:bg-gray-50 transition-colors ${item.status == 'error' ? 'bg-red-50/20' : ''}">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-gray-500">${item.fullName} • ${item.email}</div>
                                        </td>
                                        <td class="px-6 py-4 text-gray-700">${item.roleId}</td>
