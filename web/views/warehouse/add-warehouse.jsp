        ...
        <div class="bg-white shadow-sm border-b">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Thêm kho hàng</h1>
                        <p class="text-sm text-gray-500 mt-1">Tạo kho hàng mới trong hệ thống</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                <div class="p-6 border-b bg-gray-50 rounded-t-lg">
                    <h2 class="text-lg font-semibold text-gray-800"><i class="fas fa-warehouse mr-2 text-blue-600"></i>Thông tin kho hàng</h2>
                </div>
                <form action="${pageContext.request.contextPath}/warehouse/add" method="POST" class="p-6 space-y-5">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Mã kho <span class="text-red-500">*</span>
                        </label>
                        <input type="text" name="warehouseCode" value="${warehouseCode}" required
                               placeholder="VD: WH-001"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                        <p class="mt-1 text-xs text-gray-400">1-20 ký tự, chỉ chứa chữ cái, số và dấu gạch ngang (-)</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="warehouseName" value="${warehouseName}" required
                               placeholder="VD: Kho hàng Quận 1"
                               class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition">
                    </div>
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t">
                        <button type="submit" class="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm transition duration-200">
                            <i class="fas fa-plus mr-2"></i> Tạo kho hàng
                        </button>
